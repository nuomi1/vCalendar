...
const BOND_IPO_API_OPTIONS = {
  ...
  columns: "SECURITY_CODE,SECURITY_NAME_ABBR,PUBLIC_START_DATE,ISSUE_PRICE,LISTING_DATE",
  source: "WEB",
  client: "WEB",
};
...
const REITS_IPO_API_OPTIONS = {
  ...
  columns: "SECURITY_CODE,SECURITY_NAME,SUBSCRIBE_START_DATE,SALE_PRICE,RESULT_NOTICE_DATE,LISTING_DATE",
  source: "WEB",
  client: "WEB",
};
```
